...
nyc_airbnb %>%
  ...
  plot_ly(x = ~longitude, y = ~latitude, type = "scatter", mode = "markers",
          ...
          text = ~text_label)
```
Scatterplot has multiple modes, so specify type
string: \n means start a new line
single quote and double qoute are treated equally in R
...
inner_join(nyc_airbnb, common_neighborhoods,
             by = "neighbourhood") %>% #find overlay info
...
```
using plotly directly create plots better and faster
